...
def set_ops():
    ...
    free_seats_1 = { str(random.randint(1,10)), str(random.randint(1,10)),
                     str(random.randint(1,10)) }
    free_seats_2 = { str(random.randint(1,10)), str(random.randint(1,10)),
                     str(random.randint(1,10)) }

    user_interaction_functions.ask_set_questions("or", free_seats_1,
    free_seats_2, set(free_seats_1 | free_seats_2))

    user_interaction_functions.ask_set_questions("and", free_seats_1,
    free_seats_2, set(free_seats_1 & free_seats_2))

    user_interaction_functions.ask_set_questions("xor", free_seats_1,
    free_seats_2, set(free_seats_1 ^ free_seats_2))
